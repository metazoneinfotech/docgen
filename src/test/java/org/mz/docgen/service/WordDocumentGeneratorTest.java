...
public class WordDocumentGeneratorTest {
    ...
    public WordDocumentGeneratorTest(File[] files, File destination) {
        this.files = files;
    ...
    public void testGenerateSingleDocument() {
        assertEquals(1, wordDocumentGenerator.generateSingleDocument(files, destination));
    }
    ...
    public void testGenerateMultipleDocument() {
        assertEquals(1, wordDocumentGenerator.generateMultipleDocument(files, destination));
    }
